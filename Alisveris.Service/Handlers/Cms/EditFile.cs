...
namespace Alisveris.Service.Handlers
{
    public class EditFileHandler : CommandHandler<Commands.EditFile>
    {
        ...
        public EditFileHandler(IUnitOfWork unitOfWork, IRepository<Alisveris.Model.Entities.File> fileRepository)
        {
        ...
        public override async  Task<dynamic> HandleAsync(Commands.EditFile command)
        {
            ...
            var model = Mapper.Map<Alisveris.Model.Entities.File>(command);
